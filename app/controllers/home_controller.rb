class HomeController < ApplicationController
  def index
  	...
  	@url = 'https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=27513&distance=0&API_KEY=3B1F89A0-E4CC-480E-A9A2-79EFB07AAA91'
  	@uri = URI(@url)
